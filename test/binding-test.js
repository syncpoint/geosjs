...
describe('GEOS', function () {
  ...
  it('exports CAP_ROUND integer property', assertInteger('CAP_ROUND'))
  it('exports CAP_FLAT integer property', assertInteger('CAP_FLAT'))
  it('exports CAP_SQUARE integer property', assertInteger('CAP_SQUARE'))
  it('exports JOIN_ROUND integer property', assertInteger('JOIN_ROUND'))
  it('exports JOIN_MITRE integer property', assertInteger('JOIN_MITRE'))
  it('exports JOIN_BEVEL integer property', assertInteger('JOIN_BEVEL'))
